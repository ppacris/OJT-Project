    ...
    <div class="container">
        ...
        <table border="0" cellspacing="5" cellpadding="5" id="test">
            <tbody>
                <tr>
                    <td>
                        <h4><strong style="font-family: Arial, Helvetica, sans-serif;">Minimum date:</strong></h4>
                    </td>
                    <td><input type="text" id="min" name="min"></td>
                </tr>
                <tr>
                    <td>
                        <h4><strong style="font-family: Arial, Helvetica, sans-serif;">Maximum date:</strong></h4>
                    </td>
